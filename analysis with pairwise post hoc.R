...
data_aug$predator_cue <-sub("TRUE", "predator_present", data_aug$predator_cue)
data_aug$predator_cue <-sub("FALSE", "predator_absent", data_aug$predator_cue)
data_aug$conspecific_cue <-sub("TRUE", "conspecific_present", data_aug$conspecific_cue)
data_aug$conspecific_cue <-sub("FALSE", "conspecific_absent", data_aug$conspecific_cue)
...
modelxx <-glmer(Settled ~ conspecific_cue + predator_cue + conspecific_cue:predator_cue + (1|Shell) + (1|Larvae.batch), data=data, family=binomial)
...
plot(m111) 
m1111 <-ggpredict(modelx, terms = c('conspecific_cue', 'predator_cue', 'Shell')) 
plot(m1111)
...
emm_interaction1 <- emmeans(model, ~ conspecific_cue * predator_cue,  adjust = "tukey")
...
emm_interaction1111 <- emmeans(modelx, ~ conspecific_cue * predator_cue * Shell, type = "response")
emm_interaction11111 <- emmeans(modelxx, ~ conspecific_cue + predator_cue + conspecific_cue:predator_cue, type = "response")
...
pairs(emm_interaction1111)
pairs(emm_interaction11111)
...
model3xx <-glmer(Settled ~ conspecific_cue + predator_cue + conspecific_cue:predator_cue + (1|Shell) + (1|Batch), data=data_aug, family=binomial)
...
# Conduct post hoc tests with emmeans for the interaction
emm_interaction2 <- emmeans(model3, ~ conspecific_cue * predator_cue, type = "response")
...
emm_interaction22222 <- emmeans(model3xx, ~ conspecific_cue + predator_cue + conspecific_cue:predator_cue, type = "response")
...
# combined model
model6 <-glmer(Settled ~ conspecific_cue + predator_cue + Shell + conspecific_cue:predator_cue + Shell:conspecific_cue + Shell:predator_cue + (1 | Larvae.batch) + (1 | biofilm) + (1 | exp), data = data_combined, family = binomial)
model6x <-glmer(Settled ~ conspecific_cue + predator_cue + Shell + (1 | Larvae.batch) + (1 | biofilm) + (1 | exp), data = data_combined, family = binomial)
model6xx <-glmer(Settled ~ conspecific_cue + predator_cue + conspecific_cue:predator_cue + (1|Shell) + (1 | Larvae.batch) + (1 | biofilm) + (1 | exp), data = data_combined, family = binomial)

summary(model6)
summary(model6x)
m6 <- ggpredict(model6x, terms = c('conspecific_cue', 'predator_cue', 'Shell'))
plot(m6)

m6x <- ggpredict(model6x, terms = c('conspecific_cue', 'predator_cue', 'Shell'))
plot(m6x)


# Conduct post hoc tests with emmeans for the interaction 
emm_interaction3 <- emmeans(model6, ~ conspecific_cue + predator_cue, type = "response")
emm_interaction33 <- emmeans(model6x, ~ Shell * predator_cue, type = "response")
emm_interaction333 <- emmeans(model6x, ~ Shell * conspecific_cue, type = "response")
emm_interaction3333 <- emmeans(model6, ~ conspecific_cue + predator_cue + Shell + conspecific_cue:predator_cue + predator_cue:Shell + Shell:conspecific_cue, type = "response")

emm_interaction33333 <- emmeans(model6xx, ~ conspecific_cue + predator_cue + conspecific_cue:predator_cue, type = "response")

# Perform pairwise comparisons between the levels of the interaction
pairs(emm_interaction3)
pairs(emm_interaction33)
pairs(emm_interaction333)
pairs(emm_interaction3333)
pairs(emm_interaction33333)
